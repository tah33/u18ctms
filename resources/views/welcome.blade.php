                ...
                <ul class="navbar-nav">
                     ...
                     <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            ...
                            <a class="dropdown-item" href="{{ url('accounts') }}">Account Dtails</a>
                        </div>
                    </li>
                    <li class="nav-item">
                     ...
                     <li class="nav-item">
                        <a class="nav-link" href="{{url('players') }}">Player Details</a>
                    </li>
                     ...
                     <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <a class="dropdown-item" href="{{ url('run') }}">Run Rate</a>
                            <a class="dropdown-item" href="{{ url('runs') }}">Show Run &amp Rate</a>
                        </div>
                    </li>
                     <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <a class="dropdown-item" href="{{ url('team') }}">Add Team</a>
                            <a class="dropdown-item" href="{{ url('teams') }}">Show Teams</a>
                        </div>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{url('match-result')}}">Match Result</a>
                    </li>
                    <li>@auth
            ...
            <div class="col-sm-6">
                <div data-aos="fade-down-right" class="card shadow-lg p-3 mb-5 bg-white rounded" style="margin: 20px;">
                    <div class="card-body">
                        ...
                        <a href="{{ url('register') }}" class="btn btn-info" style="margin-top: 5px;">Register a Manager</a>
                    </div>
                </div>
            </div>
            <div class="col-sm-6">
                <div data-aos="fade-down-left" class="card shadow-lg p-3 mb-5 bg-white rounded" style="margin: 20px;">
                    <div class="card-body">
                        ...
                        <a href="{{url('add-match') }}" class="btn btn-info" style="margin-top: 5px;">Set Match</a>
                    </div>
                </div>
            </div>
                <div class="col-sm-6">
                    <div data-aos="fade-up-right" class="card shadow-lg p-3 mb-5 bg-white rounded" style="margin: 20px;">
                        <div class="card-body">
                            ...
                            <a href="{{ url('run') }}" class="btn btn-info">Get Run Rate</a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div data-aos="fade-up-left" class="card shadow-lg p-3 mb-5 bg-white rounded" style="margin: 20px;">
                        <div class="card-body">
                            <i class="fas fa-file-invoice-dollar"></i>
                            <a href="{{url('fees') }}" class="btn btn-info" style="margin-top: 5px;">Match Fees</a>
                        </div>
                    </div>
                </div>
            </div>
